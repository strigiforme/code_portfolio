...
const testVisitorArgs    = { id: test_id, first_visit: test_first_visit, last_visit: test_last_visit, visits: test_visits, ip: test_ip, location_string: test_location_string }

test("Visitor Constructor Test", () => {
  var test_visitor = new Visitor(testVisitorArgs);
