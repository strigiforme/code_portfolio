...
exports.getAdminAccount = async function(Admin, newEmail) {
  ...
  try {
    ...
    if (admins.length > 1) {
      ...
      console.error("WARNING: More than one admin account is present. This currently should not be possible. Manual removal of 1 or more accounts should be performed.")
      console.error("WARNING: Selecting the first admin account in the collection.");
